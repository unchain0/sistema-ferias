import { addDays, addYears, differenceInDays, format, parseISO } from 'date-fns';
...
export function calculateRevenueDeduction(monthlyRevenue: number, vacationDays: number): number {
